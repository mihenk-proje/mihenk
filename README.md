...
| SEO | **100** | **100** | **100** | **100** |
| Performans | **100** | **95** | 99 | 86 |

Düzen kayması her ölçümde sıfır, toplam engelleme süresi masaüstünde 0 ms.
Canlı ölçümde ilk içerikli boyama 0,5 s (masaüstü) / 1,3 s (mobil), en büyük
içerikli boyama 0,7 s / 2,8 s.

Canlı mobil performansı turlar arasında 99 → 93 → 95 seyretti; paket
büyüdükçe düştü, servis çalışanı önbelleğiyle bir miktar geri geldi.
Erişilebilirlik, en iyi uygulamalar ve SEO dört ölçümün hepsinde 100 kaldı.
