...
### Dönüşüm türü bazında duyarlılık

Tek bir birleşik duyarlılık sayısı, tek bir dönüşümün tamamen kaçtığını gizler.
...
## Kademe 1b/2b — Düşük çaba

**Durum: ölçülmedi.** Negatif taraf (500 normal görselin düşük çaba skoru) üretilmedi; tek yanlı bir duyarlılık sayısı yanıltıcı olurdu. Bkz. results/dusuk-caba-kalibrasyonu.md

Koddaki yürürlükteki eşik `0.65` olarak duruyor ve bu ölçümle
doğrulanmamıştır. Tek yanlı bir duyarlılık sayısı üretmek yerine boş bırakılmıştır.
